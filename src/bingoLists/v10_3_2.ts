...
export const bingoList_v10_3_2: BingoList = {
  info: { combined: "true", version: "v10.3.2" },
  normal: {
    "0": [],
    "1": [
      {
    ...
    "6": [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 0, hookshot: 0, ms: 0 },
        skill: 0,
        subtypes: { czl: 3, hearts4: 1, itemslots: 1, strength: -1 },
        time: 4.5,
    ...
    "17": [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 100, ms: 4.25 },
        skill: 0.25,
        subtypes: {
          bossdoor: 1.5,
          bosskey: 3.5,
    ...
    averageStandardDeviation: 63.58807548731278,
  },
  short: {
    "0": [
      {

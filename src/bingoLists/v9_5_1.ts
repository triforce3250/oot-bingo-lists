...
export const bingoList_v9_5_1: BingoList = {
  info: { combined: "true", version: "v9.5.1" },
  normal: {
    info: { version: "v9.5.1" },
    rowtypes: { bottle: 2, gclw: 1, hookshot: 3, ms: 11 },
    synfilters: { childchu: "min 1", endon: "max -1", legitlacs: "min -2" },
    averageStandardDeviation: 56.58478126269061,
    "0": [],
    "1": [
      {
        difficulty: 1,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 0, hookshot: 0, ms: 0 },
        skill: 0,
        subtypes: { compass: 1, map: 1, ganonchu: -1.5 },
        time: 1,
        types: { childchu: 0, selfsynergy: 0 },
        weight: -0.05,
      },
    ...
    "3": [
      ...
      },
      {
        ...
        time: 2,
        types: { lonlon: 1, selfsynergy: 0, incranchskulls: 100 },
        weight: -0.05,
      },
    ],
    "4": [
      ...
      },
      {
        ...
        skill: 0,
        subtypes: { bosskey: 2.5, gtunic: 0.25, hearts3: 0.5, firearrow: 2.5, songs5: 1 },
        time: 3,
      ...
      },
      {
        ...
        skill: 0,
        subtypes: { child2: 0.5, ganonchu: -0.5 },
        time: 3,
        types: { childchu: 0, goldrupee: 15, incgolds: 100, selfsynergy: 0 },
        weight: -0.1,
      },
    ],
    "5": [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 0, hookshot: 0, ms: 0 },
        skill: 0.25,
        subtypes: { skulls: 1.5, ganonchu: -1.5 },
        time: 3.5,
        types: { childchu: 0, selfsynergy: 0 },
    ...
    "8": [
      ...
      },
      {
        ...
        skill: 0,
        subtypes: { bosskey2: 2, hearts4: 1, map: 7, ganonchu: -0.5 },
        time: 6,
      ...
      },
      {
        ...
        time: 5.75,
        types: { childchu: 0, lonlon: 1.75, selfsynergy: 0, incranchskulls: 100 },
        weight: -0.25,
      },
      {
        difficulty: 8,
    ...
    "9": [
      ...
      },
      {
        ...
        time: 7,
        types: { beans: 5, childreset: 1.25, incbeans: 100, selfsynergy: 0 },
        weight: -0.25,
      },
      {
        difficulty: 9,
    ...
    "12": [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 0, hookshot: 0, ms: 5 },
        skill: 0,
        time: 9,
    ...
    "14": [
      ...
      },
      {
        ...
        skill: 0,
        subtypes: { child2: 1.25, hovers: 1, ganonchu: -0.5 },
        time: 10.5,
        types: {
          childchu: 0,
          fire: 2,

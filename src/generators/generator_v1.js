export var Generator_V1;
(() => {
  "use strict";
  var e = {
      785: (e, t, r) => {
        Object.defineProperty(t, "__esModule", { value: !0 }), (t.BingoBoard = void 0);
        const o = r(809),
          n = r(754);
        t.BingoBoard = class {
          constructor(e, t) {
      ...
      236: (e, t, r) => {
        ...
        t.default = class {
          ...
          generatePopulationOrder() {
            ...
            return (
              (e = e.concat(r)), this.movePositionsWithHighestDifficultyToFront(3, e), e
            );
          }
          ...
          movePositionWithDifficultyToFront(e, t) {
            ...
            if (-1 === r) throw new Error(`Can't find square with difficulty ${e}`);
            t.splice(
              t.findIndex((e) => e === r),
              1
            ),
      ...
      607: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.generateBingoBoard = t.bingoGenerator = t.ootBingoGenerator = void 0);
        const n = o(r(236)),
          i = r(882),
          s = r(685);
      ...
      644: (e, t, r) => {
        ...
        t.SynergyCalculator = class {
          constructor(e, t, r) {
            (this.profile = e), (this.rowtypeTimeSave = t), (this.synergyFilters = r);
          }

          calculateSynergyOfSquares(e) {
            const t = e.filter(o.hasGoal);
            if (this.containsDuplicateGoals(t)) return this.profile.tooMuchSynergy;
          ...
          mergeSynergiesOfSquares(e, t) {
            const r = {};
            for (const o of e)
              for (const e in o.goal[t]) r[e] || (r[e] = []), r[e].push(o.goal[t][e]);
            return r;
          }
          ...
          filterForTypeCategory(e, t) {
            if (!(e in this.synergyFilters)) return (0, n.removeHighestNumber)(t);
            const r = this.synergyFilters[e];
            return (
              "min" === r.filterType ? (0, n.sortAscending)(t) : (0, n.sortDescending)(t)
          ...
          (t.parseSynergyFilters = function (e) {
            ...
            for (const r in e) {
              const o = e[r],
                n = i(o),
                a = s(o);
              void 0 !== n && void 0 !== a && (t[r] = { filterType: n, filterValue: a });
            }
            return t;
          }),
          ...
          (function (e, t, r, o, n, i, s) {
            ...
            (t.seedrandom = function (o, u) {
              ...
              return (
                (o = c(
                  l(
                    u ? [o, e] : arguments.length ? o : [new Date().getTime(), e, window],
                    3
                  ),
                  g
                )),
